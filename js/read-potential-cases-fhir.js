...
(async () => {
  ...
  await fs.writeFile("parasitic-infections-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("parasitic-infections-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
